...
export const bibliotecaExtra: ObraLivre[] = [
  ...
  {
    id: 'unifal-normalizacao-2025', autor: 'Universidade Federal de Alfenas', ano: '2025', titulo: 'Manual de normalização e apresentação de trabalhos acadêmicos da UNIFAL-MG: com base nas normas de documentação da ABNT', publicacao: 'Sistema de Bibliotecas da UNIFAL-MG', url: 'https://repositorio.unifal-mg.edu.br/items/931ae2f8-b69d-47ff-83ee-ff7912db2480', idioma: 'pt', acesso: 'livre', disciplinas: ['CG06', 'CG12', 'CG13'], nota: 'Manual institucional público, revisto e atualizado em 2025 com base nas normas ABNT vigentes. Cobre estrutura, apresentação, projeto de pesquisa, citações, notas e referências; a própria publicação autoriza reprodução de trechos com citação da fonte. Serve como guia operacional aberto, sem substituir adaptações exigidas pela IPB ou pelo seminário.', base: 'edição autorizada',
  },
  {
