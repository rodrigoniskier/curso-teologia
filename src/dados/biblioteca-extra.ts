...
export const bibliotecaExtra: ObraLivre[] = [
  ...
  {
    id: 'anderson-linguistics2', autor: 'Catherine Anderson et al.', ano: '2022–2026', titulo: 'Essentials of Linguistics, 2nd edition', publicacao: 'eCampusOntario / McMaster University — Pressbooks', url: 'https://ecampusontario.pressbooks.pub/essentialsoflinguistics2/', idioma: 'en', acesso: 'livre', disciplinas: ['CG66', 'CG67'], nota: 'Livro-texto aberto de introdução à linguística com fonética, fonologia, morfologia, sintaxe, semântica, variação e metodologia. A edição Pressbooks oficial é mantida pela eCampusOntario e distribuída sob licença Creative Commons BY-NC-SA 4.0.', base: 'edição autorizada',
  },
  {
