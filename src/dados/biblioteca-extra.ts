...
export const bibliotecaExtra: ObraLivre[] = [
  ...
  },
  {
    ...
    idioma: 'en',
    acesso: 'livre',
    disciplinas: ['CG66', 'CG67'],
    nota: 'Livro-texto aberto de introdução à linguística com fonética, fonologia, morfologia, sintaxe, semântica, variação e metodologia. Distribuído sob licença Creative Commons BY-NC-SA 4.0.',
    base: 'edição autorizada',
  },
  {
    id: 'sapir-language',
    ...
    idioma: 'en',
    acesso: 'livre',
    disciplinas: ['CG66', 'CG67', 'CG11'],
    nota: 'Clássico em domínio público sobre linguagem como fenômeno social e cultural, sua variabilidade e suas relações com pensamento, cultura e arte. Útil historicamente ao lado de uma introdução linguística contemporânea.',
    base: 'domínio público',
  },
  {
    ...
    acesso: 'livre',
    disciplinas: ['CG66'],
    nota: 'Série de formação docente disponibilizada pelo Departamento de Estado dos EUA, com guia e demonstrações de seis métodos de ensino de línguas, incluindo audiolingual, abordagem de compreensão e abordagem comunicativa.',
    base: 'edição autorizada',
  },
  {
    ...
    acesso: 'livre',
    disciplinas: ['TH52'],
    nota: 'Relatório global construído a partir de censos e pesquisas em 201 países e territórios, útil para composição religiosa, mudança de afiliação e leitura crítica de tendências demográficas. Os dados têm ano de referência e devem ser atualizados quando nova rodada for publicada.',
    base: 'edição autorizada',
  },
  {
    ...
    acesso: 'livre',
    disciplinas: ['TH52'],
    nota: 'Relatório oficial das Nações Unidas sobre deslocamento forçado no fim de 2025, usado para avaliar diásporas, migração, hospitalidade e mudança da geografia missionária.',
    base: 'edição autorizada',
  },
  {
    ...
    acesso: 'livre',
    disciplinas: ['TH52'],
    nota: 'Fonte oficial da ONU para estimativas e metodologia de urbanização, útil tanto pelos dados quanto pela explicitação de como definições de cidade e assentamento afetam a leitura do campo.',
    base: 'edição autorizada',
  },
  {
    id: 'uscirf-2026',
    ...
    acesso: 'livre',
    disciplinas: ['TH52'],
    nota: 'Relatório público sobre condições de liberdade religiosa em 2025. É uma fonte institucional de política pública e deve ser cotejada com legislação local, organismos multilaterais e testemunho de parceiros do contexto.',
    base: 'edição autorizada',
  },
  {
    id: 'glottolog-5-3',
    ...
    idioma: 'en',
    acesso: 'livre',
    disciplinas: ['TH52', 'CG66', 'CG67'],
    nota: 'Base acadêmica aberta sobre línguas e famílias linguísticas, com versão e data explícitas. Serve para dimensionar diversidade linguística sem fingir que a classificação língua/dialeto é imutável.',
    base: 'edição autorizada',
  },
  {
    ...
    acesso: 'livre',
    disciplinas: ['TH52'],
    nota: 'Síntese contemporânea do Banco Mundial sobre expansão e desigualdade de conectividade, usada para avaliar possibilidades e limites da presença missionária mediada por plataformas.',
    base: 'edição autorizada',
  },
];
