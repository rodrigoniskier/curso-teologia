...
import { apologeticaAvancada } from './sistematica/apologetica-avancada';
...
import { praticaEnsino } from './pastoral/pratica-ensino';
...
import { pregacaoEpistolas } from './pastoral/pregacao-epistolas';
...
import { donsMinisterios } from './pastoral/dons-ministerios';
...
export const verbetes: Verbete[] = [
  ...
  sociologia,
  linguisticaAplicada,
  projetoLinguisticoMissiologico,
];
